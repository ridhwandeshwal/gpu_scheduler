-- GPU Job Scheduler — Database Schema
-- This script is the source of truth for all tables.
-- It runs automatically on first PostgreSQL container startup.
...
CREATE INDEX idx_gpu_devices_node_id ON gpu_devices(node_id);
...
CREATE INDEX idx_jobs_queue ON jobs(status, priority, submitted_at);
...
CREATE INDEX idx_job_env_vars_job_id ON job_env_vars(job_id);
...
CREATE INDEX idx_job_artifacts_run_id ON job_artifacts(job_run_id);

-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- GPU Allocations
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

CREATE TABLE job_run_gpu_allocations (
    id            UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    job_run_id    UUID        NOT NULL REFERENCES job_runs(id) ON DELETE CASCADE,
...
CREATE INDEX idx_gpu_alloc_run_id ON job_run_gpu_allocations(job_run_id);
CREATE INDEX idx_gpu_alloc_gpu_id ON job_run_gpu_allocations(gpu_device_id);
